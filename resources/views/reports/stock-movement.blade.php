    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 mb-6">
        <form action="{{ route('reports.stock-movement') }}" method="GET" class="flex flex-wrap gap-4">
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="{{ route('reports.stock-movement.pdf', request()->all()) }}" target="_blank" class="px-6 py-2 bg-red-600 text-white font-medium rounded-xl hover:bg-red-700 transition-colors flex items-center gap-2">
