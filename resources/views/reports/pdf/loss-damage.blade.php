...
@section('content')
    ...
    <h3>Barang Habis Pakai (Consumables)</h3>
    <table class="data" style="margin-bottom: 30px;">
        <thead>
            <tr>
        ...
        <tbody>
            @forelse($consumableMutations as $log)
                <tr>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align: center;">Tidak ada data kerusakan/kehilangan untuk consumables.</td>
                </tr>
            @endforelse
        </tbody>
    </table>

    <!-- Section 2: Alat & Inventaris (Tools & Equipment) -->
    <h3>Alat & Inventaris (Tools & Equipment)</h3>
    <table class="data">
        <thead>
            <tr>
                <th style="width: 15%">Tanggal</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align: center;">Tidak ada data kerusakan/kehilangan untuk tools.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
