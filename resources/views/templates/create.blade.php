    ...
    <div class="mb-8">
        <nav class="flex mb-4" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-slate-500">
                ...
                <li><span>/</span></li>
                <li class="text-slate-800 font-medium">Buat Template</li>
            </ol>
        </nav>
        <h1 class="text-2xl font-bold text-slate-800">Buat Paket Proyek</h1>
        <p class="text-slate-500">Definisikan standar kebutuhan barang untuk jenis proyek tertentu</p>
    </div>

    <form action="{{ route('templates.store') }}" method="POST" x-data="templateForm()">
        @csrf
        ...
        <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            ...
                            placeholder="Contoh: Pasang 4 CCTV Rumah">
                        @error('name')
            ...
            <div class="flex items-center justify-end gap-4">
                <a href="{{ route('templates.index') }}" class="px-6 py-3 text-slate-600 font-medium hover:text-slate-800 transition-colors">
                    Batal
                </a>
